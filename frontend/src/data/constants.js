...
export const PLANS = [
  { id: "free", name: { en: "Free", sw: "Bure" }, price: 0, desc: { en: "Get started", sw: "Anza" }, features: { en: ["3 AI tutor questions/day", "No past papers", "Basic progress"], sw: ["Maswali 3 ya AI/siku", "Hakuna karatasi za zamani", "Maendeleo ya msingi"] }, color: "#94A3B8", icon: "🆓" },
